...
createdBy.innerHTML = 'Aplicación creada por Joel Orzet';
...
function buildToDos(toDos) {
	// Tu código acá:
	const toDoArray = toDos.map((ele, index) => {
...
function displayToDos() {
	...
	toDoArray.forEach((ele) => toDoContainer.appendChild(ele));
}
...
function addToDo() {
	...
	const newToDo = new ToDo(inputValue.value);
